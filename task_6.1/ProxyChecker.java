...
public class ProxyChecker {
    public static void main(String[] args) {
        ...
        try {
            ...
            FileReader reader = new FileReader("C://edu/ip.txt");
            int c;
            String proxy = "";
            ...
            for (String ipString: ipList) {
                ...
                NotMyThread t1 = new NotMyThread(ip,port);
                t1.start();
            }
        } catch (IOException e) {
            e.printStackTrace();
...
class NotMyThread extends Thread{
    String ip;
    int port;
    public NotMyThread(String ip, int port){
        this.ip = ip;
        this.port = port;
    }
    ...
    public void run(){
        ...
        try {
            ...
            reader.close();
            System.out.println("ip: "+stringBuilder+" Р А Б О Т А Е Т ! ! ! ");
